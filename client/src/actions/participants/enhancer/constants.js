...
export const ENHANCER_SET_STATE_SHARE_SCREEN = prefixToastActions("ENHANCER_SET_STATE_SHARE_SCREEN");
export const ENHANCER_IS_SHARING_SCREEN = prefixToastActions("ENHANCER_IS_SHARING_SCREEN");
